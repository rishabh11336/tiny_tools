...
export const tools: Tool[] = [
  ...
  // Utility
  { slug: "text/hash", name: "Hash Generator", desc: "SHA-1 / 256 / 512 of any text.", group: "Utility", ready: false },
  { slug: "text/base64", name: "Base64 Encode/Decode", desc: "Text ↔ Base64.", group: "Utility", ready: false },
  { slug: "text/url", name: "URL Encode/Decode", desc: "Escape or unescape URLs.", group: "Utility", ready: false },
  { slug: "text/json", name: "JSON Formatter", desc: "Pretty-print & validate JSON.", group: "Utility", ready: false },
  { slug: "text/uuid", name: "UUID Generator", desc: "Random v4 UUIDs.", group: "Utility", ready: false },
  { slug: "text/password", name: "Password Generator", desc: "Strong random passwords.", group: "Utility", ready: false },
  { slug: "text/count", name: "Word & Char Counter", desc: "Count words, characters, lines.", group: "Utility", ready: false },
  { slug: "text/case", name: "Case Converter", desc: "UPPER / lower / Title / camel.", group: "Utility", ready: false },
